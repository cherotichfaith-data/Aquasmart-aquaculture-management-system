-- Combined full schema dump rebuilt schema-by-schema from linked production DB.
...
COMMENT ON FUNCTION "public"."api_latest_water_quality_status"("p_farm_id" "uuid", "p_system_id" bigint) IS 'L3. Component: WQ Status Badge. Reads: L1-WQ (daily_water_quality_rating). Biology source: none (refactored 2026-06 â€” L0 join removed). Delete if: WQStatusBadge removed. Last reviewed: 2026-06. Owner: @aquasmart-backend';
...
COMMENT ON FUNCTION "public"."api_recent_activity_feed"("p_farm_id" "uuid", "p_limit" integer, "p_mode" "text", "p_date_from" "date", "p_date_to" "date", "p_table" "text") IS 'L3. Component: Activity Timeline. Reads: L0 direct (7 activity tables â€” raw event display only, not biological computation). Biology source: none. Delete if: ActivityFeed component removed. Last reviewed: 2026-06. Owner: @aquasmart-backend';
...
COMMENT ON FUNCTION "public"."api_system_timeline_bounds"("p_farm_id" "uuid", "p_system_id" bigint) IS 'L3. Component: Date Range Picker. Reads: L0 metadata (stocking/harvest dates only â€” not biological computation). Delete if: timeline date picker removed. Last reviewed: 2026-06. Owner: @aquasmart-backend';
...
BEGIN
  ...
  -- Delegate ABW computation to shared resolver (resolve_abw_g)
  -- Consistent with set_stocking_abw, set_harvest_abw, trg_compute_abw_transfer
...
COMMENT ON COLUMN "public"."alert_threshold"."low_sgr_threshold" IS 'SGR (%/day) below which a warning fires. Research brief: fingerlings â‰¥3%/day; grow-out â‰¥1%/day.';
...
CREATE OR REPLACE TRIGGER "trg_normalization_review_updated_at" BEFORE UPDATE ON "public"."normalization_review" FOR EACH ROW EXECUTE FUNCTION "private"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "trg_raw_uploads_updated_at" BEFORE UPDATE ON "public"."raw_uploads" FOR EACH ROW EXECUTE FUNCTION "private"."set_updated_at"();
...
CREATE TABLE IF NOT EXISTS "realtime"."messages_2026_06_20" (
    "topic" "text" NOT NULL,
    "extension" "text" NOT NULL,
    "payload" "jsonb",
    "event" "text",
...
ALTER TABLE "realtime"."messages_2026_06_20" OWNER TO "supabase_realtime_admin";


CREATE TABLE IF NOT EXISTS "realtime"."messages_2026_06_21" (
    "topic" "text" NOT NULL,
    "extension" "text" NOT NULL,
    "payload" "jsonb",
    "event" "text",
...
ALTER TABLE "realtime"."messages_2026_06_21" OWNER TO "supabase_realtime_admin";


CREATE TABLE IF NOT EXISTS "realtime"."messages_2026_06_22" (
    "topic" "text" NOT NULL,
    "extension" "text" NOT NULL,
    "payload" "jsonb",
    "event" "text",
...
ALTER TABLE "realtime"."messages_2026_06_22" OWNER TO "supabase_realtime_admin";


CREATE TABLE IF NOT EXISTS "realtime"."messages_2026_06_23" (
    "topic" "text" NOT NULL,
    "extension" "text" NOT NULL,
    "payload" "jsonb",
    "event" "text",
...
ALTER TABLE "realtime"."messages_2026_06_23" OWNER TO "supabase_realtime_admin";


CREATE TABLE IF NOT EXISTS "realtime"."messages_2026_06_24" (
    "topic" "text" NOT NULL,
    "extension" "text" NOT NULL,
    "payload" "jsonb",
    "event" "text",
...
ALTER TABLE "realtime"."messages_2026_06_24" OWNER TO "supabase_realtime_admin";


CREATE TABLE IF NOT EXISTS "realtime"."messages_2026_06_25" (
    "topic" "text" NOT NULL,
    "extension" "text" NOT NULL,
    "payload" "jsonb",
    "event" "text",
...
ALTER TABLE "realtime"."messages_2026_06_25" OWNER TO "supabase_realtime_admin";


CREATE TABLE IF NOT EXISTS "realtime"."messages_2026_06_26" (
    "topic" "text" NOT NULL,
    "extension" "text" NOT NULL,
    "payload" "jsonb",
    "event" "text",
...
ALTER TABLE "realtime"."messages_2026_06_26" OWNER TO "supabase_realtime_admin";


CREATE TABLE IF NOT EXISTS "realtime"."messages_2026_06_27" (
    "topic" "text" NOT NULL,
    "extension" "text" NOT NULL,
    "payload" "jsonb",
    "event" "text",
...
ALTER TABLE "realtime"."messages_2026_06_27" OWNER TO "supabase_realtime_admin";
...
GRANT ALL ON TABLE "realtime"."messages_2026_06_22" TO "postgres";
GRANT ALL ON TABLE "realtime"."messages_2026_06_22" TO "dashboard_user";



GRANT ALL ON TABLE "realtime"."messages_2026_06_23" TO "postgres";
GRANT ALL ON TABLE "realtime"."messages_2026_06_23" TO "dashboard_user";



GRANT ALL ON TABLE "realtime"."messages_2026_06_24" TO "postgres";
GRANT ALL ON TABLE "realtime"."messages_2026_06_24" TO "dashboard_user";



GRANT ALL ON TABLE "realtime"."messages_2026_06_25" TO "postgres";
GRANT ALL ON TABLE "realtime"."messages_2026_06_25" TO "dashboard_user";
