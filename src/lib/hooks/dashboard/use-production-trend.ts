...
function toTrendRowFromInventory(row: InventoryTrendRow): ProductionTrendRow {
  return toTrendRow({
    ...
    cumulativeFeed: row.feeding_amount_aggregated,
    dailyMortality: row.number_of_fish_mortality,
    cumulativeMortality: row.number_of_fish_mortality_aggregated,
    transferOut: row.number_of_fish_transferred_out,
    transferIn: row.number_of_fish_transferred_in,
    harvested: row.number_of_fish_harvested,
    stocked: row.number_of_fish_stocked,
