...
import HarvestForecast from "@/features/dashboard/components/harvest-forecast"
...
import { SamplingGrowthDashboard } from "./_components/sampling-growth-dashboard"
      ...
      <div className="space-y-6">
        ...
        <section className="space-y-4">
          <SectionHeading
            ...
            description="Projected harvest dates and days remaining based on current ABW and weighted average daily growth rate."
          />
          <HarvestForecast farmId={farmId} systemId={hasSystem ? (systemId as number) : undefined} />
        </section>
