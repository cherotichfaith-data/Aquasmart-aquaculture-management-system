          ...
          <CardContent className="flex flex-col items-center py-4">
            ...
            <div className="w-full mt-4 space-y-1.5 text-xs text-muted-foreground">
              <div className="flex items-center gap-2">
                <div className="h-3 w-3 rounded-full" style={{ backgroundColor: getSemanticColor("neutral") }} />
            ...
            {allSystemsWqi.map((system) => (
              <div
                ...
                className={`p-4 rounded-lg border text-center transition-all cursor-pointer hover:scale-[1.02] ${
                  String(system.id) === selectedSystemValue ? "border-primary/35 bg-primary/10" : "border-border bg-muted/30"
                }`}
                onClick={() => {
