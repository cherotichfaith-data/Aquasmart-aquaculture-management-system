...
function Sparkline({
  ...
  const stroke =
    status === "negative" ? "stroke-destructive" : status === "positive" ? "stroke-success" : "stroke-border"
  const fill =
    status === "negative" ? "fill-destructive/15" : status === "positive" ? "fill-success/15" : "fill-muted/50"
