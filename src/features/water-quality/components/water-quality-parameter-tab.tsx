...
import { formatTimestamp, parameterLabels, type WqParameter } from "../lib/water-quality-utils"
import type { ParameterTrendRow } from "../lib/water-quality-selectors"
import {
  ...
  const chartOptions = useMemo<ChartOptions<"line">>(
    () =>
      buildCartesianOptions({
        ...
        tooltip: {
          callbacks: {
            title: (items: TooltipItem<"line">[]) => formatTimestamp(`${dateDomain[items[0]?.dataIndex ?? 0] ?? ""}T00:00:00`),
